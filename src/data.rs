...
/// This is a simple copy from [lingua Language](https://docs.rs/lingua/%5E1.7/lingua/enum.Language.html).
...
#[derive(Debug, Copy, Clone, Eq, PartialEq, Hash)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg(all(feature = "language", not(feature = "language-full")))]
#[cfg_attr(docsrs, doc(cfg(all(feature = "language", not(feature = "language-full")))))]
#[allow(missing_docs)]
pub enum Language {
    Chinese,
    English,
...
/// This is a full copy from [lingua Language](https://docs.rs/lingua/%5E1.7/lingua/enum.Language.html).
/// For reducing dependencies in the final product.
///
...
/// Tswana: 1
/// ```
// The count is generated by `cargo run --example count_languages --features language-full`.
#[derive(Debug, Copy, Clone, Eq, PartialEq, Hash)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg(feature = "language-full")]
#[cfg_attr(docsrs, doc(cfg(feature = "language-full")))]
#[allow(missing_docs)]
pub enum Language {
    Afrikaans,
    Albanian,
